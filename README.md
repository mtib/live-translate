...
bundled model is `ggml-small-q5_1` (~190 MB) — ~2× faster than
large-v3-turbo at acceptable quality for live use. Set `WHISPER_MODEL=…`
before `./build.sh` and update `WhisperCppTranscriber.bundledModelName`
to match if you want a different one.
